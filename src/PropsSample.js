...
export default function PropsSample() {
  return (<>
    ...
    <Test url='https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg' name='Product4'/>
    <Test url='https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg' name='Product5'/>
    </>
  )
}